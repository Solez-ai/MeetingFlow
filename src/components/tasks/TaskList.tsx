...
import { CheckCircle, Circle, ArrowUpRight, ChevronDown, ChevronUp } from 'lucide-react'
...
export function TaskList({ 
  ...
  const displayTasks = expanded ? sortedTasks : (limit > 0 ? sortedTasks.slice(0, limit) : sortedTasks)
  ...
  // Check if there are more tasks than the limit
  const hasMoreTasks = sortedTasks.length > limit
          ...
          {hasMoreTasks && (
            ...
            >
              {expanded ? (
                ...
                <>
                  Show {sortedTasks.length - limit} more
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-2 mt-1.5">
            ...
            {task.status === 'In Progress' && (
              <Badge className="text-xs bg-blue-100 text-blue-800 hover:bg-blue-100 h-5 px-1.5 py-0">
                In Progress
              </Badge>
            )}
          </div>
